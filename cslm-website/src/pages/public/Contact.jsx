              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-[#e0f7ff] text-[#0A95C9] rounded-full flex items-center justify-center">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-[#0A95C9] hover:text-[#0072bc] font-medium mt-2 inline-block"
                      >
                        Get Directions →
                      </a>
                    </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        ...
                        className="text-gray-600 hover:text-[#0A95C9] transition-colors"
                      >
                        +1 248-828-5305
                      </a>
                ...
                <div className="bg-gray-50 rounded-lg p-8 border-2 border-gray-200 shadow-lg">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full px-8 py-4 bg-[#0A95C9] text-white rounded-md font-semibold hover:bg-[#0072bc] transition-colors shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed transform hover:-translate-y-1 active:translate-y-0 duration-200"
                    >
